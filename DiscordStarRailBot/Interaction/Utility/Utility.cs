...
namespace DiscordStarRailBot.Interaction.Utility
{
    [Group("utility", "工具")]
    public class Utility : TopLevelModule
    {
        ...
        public async Task InviteAsync()
            => await Context.Interaction.SendConfirmAsync("<https://discordapp.com/api/oauth2/authorize?client_id=" + _client.CurrentUser.Id + "&permissions=274878024768&scope=bot%20applications.commands>", ephemeral: true);
